...
<div class="container">
    ...
    <p>El nostre lloc web empra la informació per tal de proporcionar el millor servei possible, particularment per mantenir un registre d'usuaris, de comandes en cas que apliqui, i millorar els nostres productes i serveis. És possible que siguin enviats correus electrònics periòdicament a través del nostre lloc amb ofertes especials, nous productes i altra informació publicitària que considerem rellevant per a vostè o que pugui brindar algun benefici, aquests correus electrònics seran enviats a l'adreça que vostè proporcioni i podran ser cancel·lats en qualsevol moment.
        <p>debuggers.cat està altament compromès per complir amb el compromís de mantenir la seva informació segura. Fem servir els sistemes més avançats i els actualitzem constantment per assegurar-nos que no hi hagi cap accés no autoritzat.
        </p>
        <strong>Galetes</strong>
    </p>
    <p>Una galeta es refereix a un fitxer que és enviat amb la finalitat de sol·licitar permís per emmagatzemar al seu ordinador, en acceptar aquest fitxer es crea i la galeta serveix llavors per tenir informació respecte al trànsit web, i també facilita les futures visites a una web recurrent. Una altra funció que tenen les galetes és que amb elles els webs poden reconèixer individualment i per tant brindar-te el millor servei personalitzat de la seva web.</p>
    <p>El nostre lloc web fa servir galetes per a poder identificar les pàgines que són visitades i la seva freqüència. Aquesta informació és emprada únicament per a anàlisi estadística i després la informació s'elimina de forma permanent. Vostè pot eliminar les galetes en qualsevol moment des del seu ordinador. No obstant això les galetes ajuden a proporcionar un millor servei dels llocs web, aquestes no donen accés a informació del seu ordinador ni de vostè, a menys que vostè així ho vulgui i la proporcioni directament, visites a una web. Vostè pot acceptar o negar l'ús de cookies, però la majoria de navegadors accepten galetes automàticament, ja que serveix per tenir un millor servei web. També vostè pot canviar la configuració del seu ordinador per declinar les galetes. Si es declinen és possible que no pugui utilitzar alguns dels nostres serveis.
    </p>
    <strong>Enllaços a Tercers</strong>
    <p>Aquest lloc web pogués contenir en llaços a altres llocs que puguin ser del seu interès. Una vegada que vostè de clic en aquests enllaços i abandoni la nostra pàgina, ja no tenim control sobre el lloc a què és redirigit i per tant no som responsables dels termes o privacitat ni de la protecció de les seves dades en aquests altres llocs tercers. Aquests llocs estan subjectes a les seves pròpies polítiques de privacitat per la qual cosa és recomanable que els consulti per confirmar que vostè està d'acord amb aquestes.
    </p>
    <strong>Control de la seva informació personal</strong>
    <p>En qualsevol moment vostè pot restringir la recopilació o l'ús de la informació personal que és proporcionada al nostre lloc web. Cada vegada que se li demani omplir un formulari, com el d'alta d'usuari, pot canviar la selecció l'opció de rebre informació per correu electrònic. En cas que hagi marcat l'opció de rebre el nostre butlletí o publicitat vostè pot cancel·lar-la en qualsevol moment.</p>
    <p>Aquesta companyia no vendrà, cedirà o distribuirà la informació personal que és recopilada sense el seu consentiment, llevat que sigui requerit per un jutge amb un ordre judicial.</p>
    <p>debuggers.cat es reserva el dret de canviar els termes de la present Política de Privacitat en qualsevol moment.</p>
</div>
</section>
